import { ShoppingBasket, CircleDollarSign, AlignStartVertical, Layers } from 'lucide-react'
        ...
        <Modal open={open} onClose={toggleModal}>
          <div className='text-center w-140 flex flex-col gap-10'>
            <div className='mx-auto my-4'>
              <h3 className='text-lg text-gray-800'>Adicionar Produto</h3>
            </div>
            <form className='flex flex-col gap-5 text-xs text-black'>
              ...
              <div className='flex items-center gap-3'>
                ...
                <input type="number" placeholder='Preço' className='w-full p-2 rounded-lg transition-all ease-in-out duration-200 outline-0 border border-gray-200 focus:border-sky-400' />
              </div>
              <div className='flex items-center gap-3'>
                <AlignStartVertical size={16} />
                <input type="text" placeholder='Categoria' className='w-full p-2 rounded-lg transition-all ease-in-out duration-200 outline-0 border border-gray-200 focus:border-sky-400' />
              </div>
              <div className='flex items-center gap-3'>
                <Layers size={16} />
                <input type="number" placeholder='Quantidade' className='w-full p-2 rounded-lg transition-all ease-in-out duration-200 outline-0 border border-gray-200 focus:border-sky-400' />
              </div>
            </form>
